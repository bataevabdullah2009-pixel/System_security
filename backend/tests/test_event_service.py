...
from app.db.database import Base, get_engine, init_db, reset_database_engine_cache, session_scope
...
def test_build_event_key() -> None:
    assert event_service.build_event_key("101", "vehicle_detected") == "101:vehicle_detected"
