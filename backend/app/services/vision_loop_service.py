...
def update_once(channel: int | str) -> dict[str, object]:
    ...
    image_bytes, snapshot_path, _latest_path = camera_service.capture_fresh_snapshot(channel_key)
    ...
    annotated_path = vision_overlay_service.save_latest_annotated_frame(channel_key, annotated_bytes)
